...
Guidance for AI coding agents working on the Varbase Blog Base recipe.
...
- **Merge request comments and history** on
  [git.drupalcode.org/project/varbase_blog_base](https://git.drupalcode.org/project/varbase_blog_base/-/merge_requests)
  — the reasoning behind recent changes lives in the MR discussions.
- **Issue comments** on
  [drupal.org/project/issues/varbase_blog_base](https://www.drupal.org/project/issues/varbase_blog_base)
